function varargout = GLW_sum_epochs(varargin)
% GLW_SUM_EPOCHS MATLAB code for GLW_average_epochs.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_sum_epochs_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_sum_epochs_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_average_epochs is made visible.
function GLW_sum_epochs_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_average_epochs (see VARARGIN)
% Choose default command line output for GLW_average_epochs
...
%!!!!!!!!!!!!!!!!!!!!!!!!
a=find(strcmpi(configuration.parameters.operation,get(handles.operation_popup,'String'))==1);
if isempty(a);
else
...
function varargout = GLW_sum_epochs_OutputFcn(hObject, eventdata, handles) 
