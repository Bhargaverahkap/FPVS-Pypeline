...
% Belgium
% 
% Function Modified by Corentin Jacques (UCL) to fix a bug, add the
% <NbChunks2Remove> variable and the ability to use stimulation cycles
...
%
%       Edited to get the number of chunks correct if using an overlap
%       between chunks (CJacques and JLiu).
        numchunks = floor((header.datasize(6)-(dx_offset-1)- (dx_epochlength - dx_epochstep))/dx_epochstep);
    end;
end;
